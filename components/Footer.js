    ...
    <>
      <div className="bg-moredark text-gray-300 py-5">
        <div className="w-4/5 m-auto">
          <div className="flex flex-col lg:flex-row lg:justify-center">
            <div className="flex flex-col lg:grid lg:grid-cols-2 items-start gap-8 ml-3 mt-5 text-white">
              ...
              >
                ...
                <p className="text-gray-300 ml-2 inline text-sm hover:text-ligthblue transition-all">
                  /aeroclubrafaela_
                </p>
              </a>
              <a
          ...
          <div className="mb-4">
            <p className="text-sm mx-auto w-4/5 text-center">
              Diseñador Web: Francis Willener
            </p>
            <div className="flex justify-center items-center gap-3 mt-3">
              <a
                href="mailto:willenerfrancis0@gmail.com"
                className="bg-gray-300 py-1 px-2 rounded-full text-moredark hover:text-red-400 transition-all"
              >
              ...
              <a
                ...
                target="_BLANCK"
                className="bg-gray-300 py-1 px-2 rounded-full text-moredark hover:text-black transition-all"
              >
                <i className="bx bxl-github"></i>
              </a>
              <a
                href="https://www.linkedin.com/in/francis-willener-38369320b/"
                target="_BLANCK"
                className="bg-gray-300 py-1 px-2 rounded-full text-moredark hover:text-blue-400 transition-all"
              >
