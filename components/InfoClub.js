...
function InfoClub() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col mx-auto lg:flex-row items-center justify-center text-white gap-10 lg:gap-0 sm:w-2/3 lg:w-full xl:w-3/4 my-16 lg:mx-auto">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 pb-8 pl-5 pr-16 flex flex-col items-start justify-end z-5 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity bg-black bg-opacity-50 text-white">
                ...
                <p className="text-sm md:text-md">{info.description}</p>
              </div>
            </Link>
          </div>
        ))}
